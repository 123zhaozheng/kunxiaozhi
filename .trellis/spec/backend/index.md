...
| [WeCom Runtime & Delivery](./wecom-runtime-delivery.md) | Bot-scoped sessions, user ownership, run-scoped channel prompt, long-text segmentation, reveal-file boundary | Filled |
