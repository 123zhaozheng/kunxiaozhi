...
| [TeamAgent Complex-Task Harness](./teamagent-harness.md) | Deterministic attachment materialization, roster snapshots, SOP approval gate, structured handoffs, run recovery/events | Filled |
