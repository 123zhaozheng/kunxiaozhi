...
EXTRA_SETTING_DEFINITIONS: dict[str, dict] = {
    ...
    "USER_STORAGE_ENFORCEMENT_ENABLED": {
        "type": SettingType.BOOLEAN,
        "category": SettingCategory.USER,
        "subcategory": "personal_quota",
        "description": "settingDesc.USER_STORAGE_ENFORCEMENT_ENABLED",
        "default": True,
        "frontend_visible": True,
    },
    "USER_STORAGE_DEFAULT_QUOTA_MB": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.USER,
        "subcategory": "personal_quota",
        "description": "settingDesc.USER_STORAGE_DEFAULT_QUOTA_MB",
        "default": 1024,
        "minimum": 1,
        "frontend_visible": True,
    },
    "USER_STORAGE_WARNING_PERCENT": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.USER,
        "subcategory": "personal_quota",
        "description": "settingDesc.USER_STORAGE_WARNING_PERCENT",
        "default": 80,
        "minimum": 1,
        "maximum": 99,
        "frontend_visible": True,
    ...
    "OA_SSO_ENABLED": {
        ...
        "category": SettingCategory.SECURITY,
        "subcategory": "oa_sso",
        "description": "settingDesc.OA_SSO_ENABLED",
        "default": False,
        "frontend_visible": True,
    },
    "OA_SSO_BASE_URL": {
        ...
        "category": SettingCategory.SECURITY,
        "subcategory": "oa_sso",
        "description": "settingDesc.OA_SSO_BASE_URL",
    ...
    "OA_SSO_PUBLIC_KEY": {
        ...
        "category": SettingCategory.SECURITY,
        "subcategory": "oa_sso",
        "description": "settingDesc.OA_SSO_PUBLIC_KEY",
        "default": "",
        "depends_on": "OA_SSO_ENABLED",
        "is_sensitive": True,
    },
    "OA_SSO_CHANNEL_ID": {
        ...
        "category": SettingCategory.SECURITY,
        "subcategory": "oa_sso",
        "description": "settingDesc.OA_SSO_CHANNEL_ID",
        "default": "aimp",
        "depends_on": "OA_SSO_ENABLED",
    },
    "OA_SSO_EMAIL_DOMAIN": {
        ...
        "category": SettingCategory.SECURITY,
        "subcategory": "oa_sso",
        "description": "settingDesc.OA_SSO_EMAIL_DOMAIN",
        "default": "ksrcb.com",
        "depends_on": "OA_SSO_ENABLED",
    },
    "OA_SSO_AUTO_PROVISION": {
        "type": SettingType.BOOLEAN,
        "category": SettingCategory.SECURITY,
        "subcategory": "oa_sso",
        "description": "settingDesc.OA_SSO_AUTO_PROVISION",
        "default": True,
        "depends_on": "OA_SSO_ENABLED",
        "frontend_visible": True,
    },
    ...
    "DIFY_KB_ENABLED": {
        ...
        "subcategory": "general",
        "description": "settingDesc.DIFY_KB_ENABLED",
        "default": False,
        "frontend_visible": True,
    },
    "DIFY_KB_BASE_URL": {
        ...
        "category": SettingCategory.DIFY,
        "subcategory": "connection",
        "description": "settingDesc.DIFY_KB_BASE_URL",
        "default": "",
    ...
    "DIFY_KB_API_KEY": {
        ...
        "category": SettingCategory.DIFY,
        "subcategory": "connection",
        "description": "settingDesc.DIFY_KB_API_KEY",
        "default": "",
        "depends_on": "DIFY_KB_ENABLED",
        "is_sensitive": True,
    },
    "DIFY_KB_RERANK_MODEL_ID": {
        ...
        "category": SettingCategory.DIFY,
        "subcategory": "models",
        "description": "settingDesc.DIFY_KB_RERANK_MODEL_ID",
        "default": "",
        "depends_on": "DIFY_KB_ENABLED",
        "frontend_visible": True,
    },
    "DIFY_KB_SEARCH_METHOD": {
        "type": SettingType.SELECT,
        "category": SettingCategory.DIFY,
        "subcategory": "retrieval",
        "description": "settingDesc.DIFY_KB_SEARCH_METHOD",
        "default": "hybrid_search",
        "depends_on": "DIFY_KB_ENABLED",
        "options": ["hybrid_search", "semantic_search", "keyword_search", "full_text_search"],
        "frontend_visible": True,
    },
    "DIFY_KB_TOP_K": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.DIFY,
        "subcategory": "retrieval",
        "description": "settingDesc.DIFY_KB_TOP_K",
        "default": 10,
        "depends_on": "DIFY_KB_ENABLED",
        "frontend_visible": True,
    },
    "DIFY_KB_RERANK_TOP_K": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.DIFY,
        "subcategory": "retrieval",
        "description": "settingDesc.DIFY_KB_RERANK_TOP_K",
        "default": 5,
        "depends_on": "DIFY_KB_ENABLED",
        "frontend_visible": True,
    },
    "DIFY_KB_SCORE_THRESHOLD": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.DIFY,
        "subcategory": "retrieval",
        "description": "settingDesc.DIFY_KB_SCORE_THRESHOLD",
        "default": 0.4,
        "depends_on": "DIFY_KB_ENABLED",
        "frontend_visible": True,
    },
    "DIFY_KB_SEMANTIC_WEIGHT": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.DIFY,
        "subcategory": "retrieval",
        "description": "settingDesc.DIFY_KB_SEMANTIC_WEIGHT",
        "default": 0.7,
        "depends_on": "DIFY_KB_ENABLED",
        "frontend_visible": True,
    },
